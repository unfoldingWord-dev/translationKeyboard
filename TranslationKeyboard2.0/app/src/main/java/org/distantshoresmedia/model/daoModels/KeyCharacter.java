 ...
 */
public class KeyCharacter extends org.distantshoresmedia.model.TKDatabaseModel  implements java.io.Serializable {
    ...
    public static KeyCharacter getModelForId(long id, DaoSession session){
        return session.getKeyCharacterDao().load(id);
    }
    // KEEP METHODS END

 ...
 */
public class KeyboardVariant extends org.distantshoresmedia.model.TKDatabaseModel  implements java.io.Serializable {
    ...
    public static KeyboardVariant getModelForId(long id, DaoSession session){
        return session.getKeyboardVariantDao().load(id);
    }
    // KEEP METHODS END

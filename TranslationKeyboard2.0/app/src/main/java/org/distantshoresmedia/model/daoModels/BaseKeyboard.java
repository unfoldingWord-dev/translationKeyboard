 ...
 */
public class BaseKeyboard extends org.distantshoresmedia.model.TKDatabaseModel  implements java.io.Serializable {
    ...
    public static BaseKeyboard getModelForId(long id, DaoSession session){
        return session.getBaseKeyboardDao().load(id);
    }
    // KEEP METHODS END
